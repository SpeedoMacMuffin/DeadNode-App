  ...
  return (
    <div className="flex center message stats">
      <div>
        ...
        <span className="stack">Connected Clients: 1</span>
        <span className="stack">CPU Temp.: 36.4°C</span>
        <span className="stack">RAM Total: 440412 kb</span>
        <span className="stack">RAM Usage: 14%</span>
        <FormWifi
          name="wifi"
